...
const uk: Partial<Record<TranslationKey, string>> = {
  ...
  'editor.advanced.schedule.hint':
    'Автоматично запускати цей профіль у визначений час, у обрані дні — за локальним системним часом. Вимкнено за замовчуванням. Пропускається, якщо профіль уже запущено.',
