  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-panel" style={{ width: 380, padding: 20 }} onClick={(e) => e.stopPropagation()}>
        <h3 style={{ marginTop: 0 }}>{t('proxy.edit.title')}</h3>
        {error && <div className="banner banner-error">{error}</div>}

        <label className="field" style={{ display: 'block', marginBottom: 8 }}>
          {t('proxy.namePlaceholder')}
          <input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} style={{ display: 'block', width: '100%', marginTop: 4 }} />
        </label>
        <label className="field" style={{ display: 'block', marginBottom: 8 }}>
        ...
        <label className="field" style={{ display: 'block', marginBottom: 8 }}>
          ...
          <input value={form.host} onChange={(e) => setForm({ ...form, host: e.target.value })} style={{ display: 'block', width: '100%', marginTop: 4 }} />
        </label>
        <label className="field" style={{ display: 'block', marginBottom: 8 }}>
        ...
        <label className="field" style={{ display: 'block', marginBottom: 8 }}>
          ...
          <input value={form.username} onChange={(e) => setForm({ ...form, username: e.target.value })} style={{ display: 'block', width: '100%', marginTop: 4 }} />
        </label>
